      ...
      {!forgetPWD && (
        <section className='bg-login py-4'>
          <div className='container'>
            <div className="row">
              <h3 className='text-center pb-3 text-white'>LOGIN OR REGISTER AN ACCOUNT</h3>
              <div className='col-lg-12 col-xl-10 mx-auto'>
                <div className="d-flex align-items-strech flex-wrap flex-xl-nowrap">
                  <div className="bg-primary p-4 flex-fill w50">
                    ...
                    <form onSubmit={login} method="post" >
                      <div className="mb-2">
                        <input type="email" className="form-control text-muted form-control-lg rounded-0 border p-3"
                          name="email" placeholder="email@address.com" maxLength={50} required />
                        <span id="login-email-error" className="invalid-feedback"></span>
                      </div>
                      <div className="mb-2">
                        <div className="position-relative">
                          <input type="password"
                            className="form-control text-muted form-control-lg rounded-0 border p-3" name="password"
                            placeholder="8+ characters required" minLength={8} maxLength={30} required />
                          <a className="position-absolute top-50 end-0 translate-middle me-2"
                            href="javascript:;">
                            <i id="changePassIcon" className="bi-eye-slash"></i>
                          </a>
                          <span id="login-pwd-error" className="invalid-feedback"></span>
                        </div>
                      </div>
                  ...
                  <div className="bg-white p-4 flex-fill w50">
                    ...
                    <form onSubmit={register} method="post" >
                      <div className="my-2">
                        <input type="text" className="form-control text-muted form-control-lg rounded-0 border p-3"
                          name="name" minLength={3} maxLength={20} placeholder="Your Full Name" required />
                        <span id="name-error" className="invalid-feedback"></span>
                      </div>
                      <div className="mb-2">
                        <input type="email" className="form-control text-muted form-control-lg rounded-0 border p-3"
                          name="email" maxLength={50} placeholder="email@address.com" required />
                        <span id="reg-email-error" className="invalid-feedback"></span>
                      </div>
                      <div className="mb-2">
                        <div className="position-relative">
                          <input type="password" className="form-control text-muted form-control-lg rounded-0 border p-3" name="password" minLength={8} maxLength={12}
                            placeholder="8+ characters required" required />
                          <a className="position-absolute top-50 end-0 translate-middle me-2"
                            href="javascript:;">
                            <i id="changePassIcon" className="bi-eye-slash"></i>
                          </a>
                          <span id="reg-pwd-error" className="invalid-feedback"></span>
                        </div>
                      </div>
                      <div className="mb-2">
                        {/* <Countries /> */}
            ...
            <div className="row justify-content-center align-items-center g-0">
              ...
              <div className="col-lg-5">
                <div className="bg-primary p-4">
                  <div className="text-center">
                    <div className="mb-4">
                      <p>Please enter email address of your account and we will send you a link in email to reset your password.</p>
                    </div>
                  </div>
                  <form onSubmit={forgotPassword} method="post" name="forget-pwd-form" >
                    ...
                    <div className='text-center mt-3'>
                      <span style={{ cursor: "pointer" }} onClick={() => setForgetPWD(false)} >Back to Sign In</span>
                    </div>
                  </form>
                </div>
              </div>
...
const login = async (e) => {
  ...
  if (!email || !email.includes('@'))
    return document.getElementById('login-email-error').innerHTML = 'Please enter a valid email address';

  if (!password)
    return document.getElementById('login-pwd-error').innerHTML = 'Please enter a valid password';
...
const register = async (e) => {
  ...
  if (!email || !email.includes('@'))
    return document.getElementById('reg-email-error').innerHTML = 'Please enter a valid email address';
